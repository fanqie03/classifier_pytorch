...
def get_args():
    ...
    parser.add_argument('--model_path', default='checkpoint/Thu Aug 15 17:43:31 2019/model_Net.pth', help='path of saved model file')
    parser.add_argument('--model', default='Net', help='model type')
    parser.add_argument('--input_dir', default='/home/cmf/datasets/extract_data/test', help='the directory of test')
