train_datasets = [
    dict(type='ImageFolder',
         root='/home/cmf/datasets/spoof/raw_rgb/train'),
    dict(type='ImageFolder',
         root='/home/cmf/datasets/spoof/NUAADetectedface/train_val/train'),
    # dict(type='ImageFolder',
...
val_datasets = [
    dict(type='ImageFolder',
         root='/home/cmf/datasets/spoof/raw_rgb/val'),
    dict(type='ImageFolder',
         root='/home/cmf/datasets/spoof/NUAADetectedface/train_val/val'),
]
...
train = dict(
    ...
    freeze_head=False,
    # resume_from=None,
    resume_from='checkpoint/spoof-FeatherNetB-2019-12-06-09-38-39/ckpt/FeatherNetB-Epoch-9-Loss-0.0005025619130608168.pth',
    init_type='xavier',
    work_dir='checkpoint',
    num_epochs=200,
    batch_size=64,
...
transform = [
    ...
    dict(type='RandomAffine', degrees=15, scale=(0.9, 1.1)),
...
theme = 'spoof-{}-'.format(model.get('type'))