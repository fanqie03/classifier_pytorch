train_datasets = [
    ...
    dict(type='ImageFolder',
         root='/home/cmf/datasets/helmet/helmet_by_dataset/train_val/train'),
    # dict(type='ImageFolder',
...
val_datasets = [
    dict(type='ImageFolder',
         root='/home/cmf/datasets/helmet/helmet-wash/val'),
    dict(type='ImageFolder',
         root='/home/cmf/datasets/helmet/helmet_by_dataset/train_val/val'),
]
